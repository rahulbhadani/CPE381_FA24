...
% Label the points
text(C(1), C(2), '(x, y)', 'FontSize', 24, 'Interpreter', 'latex', 'HorizontalAlignment', 'left');

% Label the sides
text(b/2, -0.15, 'x', 'FontSize', 24, 'Interpreter', 'latex', 'HorizontalAlignment', 'center'); % Base
text(b+0.05, p/2, 'y', 'FontSize', 24, 'Interpreter', 'latex', 'HorizontalAlignment', 'left'); % Perpendicular
text(b/2, p/2+0.1, 'r', 'FontSize', 24, 'Interpreter', 'latex', 'HorizontalAlignment', 'center'); % Hypotenuse
...
%% Save figure
exportgraphics(f, sprintf('../figures/complex_num.pdf'));
